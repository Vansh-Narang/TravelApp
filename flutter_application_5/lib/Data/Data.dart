class RecommedationModel {
  String name;
  String image;

  RecommedationModel(this.name, this.image);
}

List<RecommedationModel> recommendations = recommendationsData
    .map((item) => RecommedationModel(item['name']!, item['image']!))
    .toList();
